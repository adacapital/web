                ...
                <div class="row align-items-center justify-content-center p-4 col-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="card-static-item">
                                        ...
                                        <div class="card-static-item-value"><strong><span>159,813<sup> ADA</sup></span></strong></div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="card-static-item">
                            ...
                            <div class="row"> */}
                                <div class="col-6">
                                    <div class="card-static-item">
                                        ...
                                        <div class="card-static-item-value"><strong><span>0.23%</span></strong></div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="card-static-item">
                                        <div class="card-static-item-title">Lifetime Blocks</div>
                                        <div class="card-static-item-value"><strong><span>215</span></strong></div>
                                    </div>
                                </div>
                                {/* </div>
                            <div class="row"> */}
                    ...
                    <div id="cardGrp2_4_content" style={{ display: 'none' }}>
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="a-grad1 glow-on-hover" href="https://bit.ly/3PGnxms" target="_blank" rel="noopener noreferrer"><img src="img/badge_preprod.webp" alt="" class="responsive-image" /></a>
