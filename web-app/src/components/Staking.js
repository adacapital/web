            ...
            <div class="container">
                ...
                <div class="row align-items-center justify-content-center p-4 col-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="card-static-item">
                                        ...
                                        <div class="card-static-item-value"><strong><span>243,274<sup> ADA</sup></span></strong></div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="card-static-item">
                            ...
                            <div class="row"> */}
                                <div class="col-6">
                                    <div class="card-static-item">
                                        ...
                                        <div class="card-static-item-value"><strong><span>15,000<sup> ADA</sup></span></strong></div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="card-static-item">
                            ...
                            <div class="row"> */}
                                <div class="col-6">
                                    <div class="card-static-item">
                                        ...
                                        <div class="card-static-item-value"><strong><span>0.31%</span></strong></div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="card-static-item">
                                        <div class="card-static-item-title">Lifetime Blocks</div>
                                        <div class="card-static-item-value"><strong><span>216</span></strong></div>
                                    </div>
                                </div>
                                {/* </div>
                            <div class="row"> */}
                    ...
                    <div id="cardGrp2_4_content" style={{ display: 'none' }}>
                        ...
                        <p class="large-first-letter">We also support the more recent Cardano Preview and PreProd testnets by running the <a class="a-grad1 glow-on-hover" href="https://bit.ly/3AL7HCE" target="_blank" rel="noopener noreferrer"><strong>ADACT Preview Pool</strong></a> and the <a class="a-grad1 glow-on-hover" href="https://bit.ly/3D3wbqQ" target="_blank" rel="noopener noreferrer"><strong>ADACT PreProd Pool</strong></a> 24/7.</p>
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="a-grad1 glow-on-hover" href="https://bit.ly/3AL7HCE" target="_blank" rel="noopener noreferrer"><img src="img/badge_preview.webp" alt="" class="responsive-image" /></a>
